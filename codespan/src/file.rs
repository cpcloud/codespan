    ...
    Source: Clone + AsRef<str>,
{
    ...
    fn line(&self, id: FileId, line_index: usize) -> Option<codespan_reporting::files::Line> {
    ...
    fn source(&self, id: FileId) -> Option<Source> {
        Some(self.source(id).clone())
    }
}
